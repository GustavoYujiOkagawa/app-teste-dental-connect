...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
              ...
              <div className="p-6">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      {profile?.type === 'dentist' ? 'Dentista' : 'Protético'}
                      {profile?.specialty && ` • ${profile.specialty}`}
                    </p>
                    {profile?.clinic_name && (
                      <p className="text-gray-500 text-sm">{profile.clinic_name}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="mt-6 flex justify-between">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600">Análises</p>
                  </div>
                  <div className="text-center">
            ...
            <div className="bg-white rounded-lg shadow overflow-hidden">
              <div className="p-6">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-lg font-bold text-gray-900">Histórico de Análises</h3>
                  <button
                ...
                {analyses.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <h4 className="mt-2 text-gray-600">Nenhuma análise encontrada</h4>
                    <p className="text-gray-500 text-sm mt-1">
                      Comece capturando uma foto ou enviando uma imagem para análise
                    </p>
                  </div>
                ) : (
                            ...
                            <div>
                              ...
                              <div className="flex items-center mt-1">
                                <div 
                                  ...
                                  style={{ backgroundColor: analysis.tooth_color_hex }}
                                ></div>
                                <span>{analysis.tooth_color_code}</span>
                              </div>
                            </div>
                            <div>
                              ...
                              <div className="flex items-center mt-1">
                                <div 
                                  className="w-4 h-4 rounded-full mr-1" 
                                  style={{ backgroundColor: analysis.gum_color_hex }}
                                ></div>
                                <span>{analysis.gum_color_code}</span>
                              </div>
                            </div>
                          </div>
                          {analysis.notes && (
                            <p className="mt-2 text-sm text-gray-700">{analysis.notes}</p>
                          )}
      ...
      <div className="fixed left-4 top-1/2 transform -translate-y-1/2 bg-white rounded-lg shadow-lg p-2 hidden md:block">
        <div className="flex flex-col space-y-4">
          <button
            onClick={() => router.push('/settings')}
            className="p-2 hover:bg-gray-100 rounded-md tooltip-container"
            title="Configurações"
          >
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 py-3">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-around">
          ...
          <button
            onClick={() => router.push('/settings')}
            className="flex flex-col items-center text-gray-500 md:hidden"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
              <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.325.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 0 1 1.37.49l1.296 2.247a1.125 1.125 0 0 1-.26 1.431l-1.003.827c-.293.241-.438.613-.43.992a7.723 7.723 0 0 1 0 .255c-.008.378.137.75.43.991l1.004.827c.424.35.534.955.26 1.43l-1.298 2.247a1.125 1.125 0 0 1-1.369.491l-1.217-.456c-.355-.133-.75-.072-1.076.124a6.47 6.47 0 0 1-.22.128c-.331.183-.581.495-.644.869l-.213 1.281c-.09.543-.56.94-1.11.94h-2.594c-.55 0-1.019-.398-1.11-.94l-.213-1.281c-.062-.374-.312-.686-.644-.87a6.52 6.52 0 0 1-.22-.127c-.325-.196-.72-.257-1.076-.124l-1.217.456a1.125 1.125 0 0 1-1.369-.49l-1.297-2.247a1.125 1.125 0 0 1 .26-1.431l1.004-.827c.292-.24.437-.613.43-.991a6.932 6.932 0 0 1 0-.255c.007-.38-.138-.751-.43-.992l-1.004-.827a1.125 1.125 0 0 1-.26-1.43l1.297-2.247a1.125 1.125 0 0 1 1.37-.491l1.216.456c.356.133.751.072 1.076-.124.072-.044.146-.086.22-.128.332-.183.582-.495.644-.869l.214-1.28Z" />
              <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
